            ...
            <main className='container'>
                {title == "Your Guide to Great Movies" ? (<div className='bg-body-tertiary p-5 border mb-5'>
                    ...
                    <p className='lead'>Discover movies you&apos;ll love with personalized suggestions,
                        curated collections, and quick searches - your guide to finding great
                        films</p>
                    <button onClick={() => navigotor("/movies/upcoming")} className='btn btn-primary'>Explore Now</button>
                </div>) : ""}
